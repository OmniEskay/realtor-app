    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src='https://plus.unsplash.com/premium_photo-1661775953246-410e3a33977c?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt='key' 
          className='w-full rounded-2xl'/>
        </div>
        <div className='w-fill md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
            <input 
             type='email'
             id="email"
             ...
             className="mb-6 w-full px-4 py-2 text-xl text-grey-700 bg-white border-grey-300 rounded transition ease-in-out"
             />
             ...
             className="w-full px-4 py-2 text-xl text-grey-700 bg-white border-grey-300 rounded transition ease-in-out"
             />
             {showPassword ? (
          ...
          <div className='flex items-center my-4 before:border-t  before:flex-1  before:border-grey-300
